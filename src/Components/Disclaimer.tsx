const Disclaimer = () => (
    <div>
        ...
        <ul>
            ...
            <li><strong>Website</strong> refers to MrPewPewLaser, accessible from <a href="https://www.mrpewpewlaser.me/" rel="external nofollow noopener" target="_blank">https://www.mrpewpewlaser.me/</a></li>
        </ul>
        <h1>Disclaimer</h1>
